...
export default function HomePage() {
  ...
  return (
    <div className="container max-w-2xl mx-auto p-4">
      <h1 className="text-2xl font-bold text-center mb-6">Rastreador de Dieta</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-6">
        ...
        <TabsContent value="dashboard" className="space-y-4">
          ...
          {/* Substituir a renderização dos cards de progresso no Dashboard */}
              ...
              return (
                <Card key={group.name}>
                  <CardContent className="p-4">
                    ...
                    <Progress value={goal === "" ? 0 : (consumed / Number(goal)) * 100} className={`h-2 ${group.color}`} />
                  </CardContent>
                </Card>
              )
            })}
          ...
          <div className="mt-6">
            <h3 className="font-semibold mb-2">Refeições de Hoje</h3>
                  ...
                  .map((meal) => (
                    <Card key={meal.id}>
                      <CardContent className="p-4">
                        ...
                        {/* Modificar a exibição das porções nas refeições para mostrar números decimais */}
          ...
          <Button className="w-full mt-4" onClick={() => setMealDialogOpen(true)}>
            Adicionar Refeição
          </Button>
